...
function App() {
  ...
  const { books, loading: booksLoading, error: booksError, addBook, removeBook, updateBook, addBookmark, removeBookmark, updateBookmark } = useBooks();
      ...
      {showInstallPrompt && (
        <div style={{
          ...
          <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
            Get quick access to your books. Install as an app on your device.
          </div>
      ...
      {currentView !== 'reader' && (
        <header className="showcase-header">
          ...
          <div className="header-actions">
            ...
            {/* Auth button */}
            {authLoading ? (
              <div style={{ padding: '6px 8px', fontSize: 12 }}>Loading…</div>
            ) : user ? (
              <div style={{ position: 'relative' }}>
                ...
                {showUserMenu && (
                  ...
                  >
                    <div style={{ padding: '12px 16px', borderBottom: '1px solid var(--border-color)', fontSize: 12 }}>
